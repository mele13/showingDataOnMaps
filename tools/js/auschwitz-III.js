...
function init() {
    ...
    loader.load("../osm/auschwitz-III.osm", function (text) {
        ...
        for (let i = 0; i < x.length; i++) {
            ...
            for (let j = 0; j < tags.length; j++) {
                if (tags[j].hasAttribute("k")) {
                    ...
                    if (tags[j].getAttribute("v") == "monument") { interest = 3; break; }
                    if (tags[j].getAttribute("v") == "forest") { interest = 4; break; }                  
                }
            ...
            if (interest > 0) {
                ...
                switch (interest) {
                    ...
                    case 3: drawBuildings(points, 0xF448FF); break; // Monuments
                    case 4: drawBuildings(points, 0x7CFF00); break; // Concentration camp memorial
                }
